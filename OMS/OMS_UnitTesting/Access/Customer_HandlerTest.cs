...
public class CustomerHandlerTests
{
    ...
    {
        int zip_ID = handler.Create_ZIPCode_Database(12345, "Testland", "Testville");
    ...
    public void Add_Customer_toDatabase_test()
    {
        var customer = new Customer(
            ...
            "test@example.com",
            12345678,
            new Address("Test Street", new ZIPCode(12345, "Testland", "Testville") )
        );

        int customerId = handler.Create_Customer_Database(customer);
